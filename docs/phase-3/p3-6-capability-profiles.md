...
| --- | --- | --- | --- | --- |
| `portable_cpu` | Current laptop and deterministic CI/reference use | ONNX Runtime CPU reference | C1 correctness and small CPU evidence only until measured | Non-executable R0, U3B, compatibility U3C `A/A/A/A`, and supply-chain U3D `A/A/A/A/A` policies accepted; six resolver inputs, exact bindings, actual artifacts, and executable validation remain unresolved |
